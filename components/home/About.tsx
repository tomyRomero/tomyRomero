    ...
    >
      <motion.section>
            ...
            >
              ...
              In the realm of database management, I am well-versed in both relational databases like <strong>SQL</strong> (Structured Query Language) and also NoSQL databases such as <strong>MongoDB</strong>. Alongside this, I possess adept knowledge of <strong>Restful APIs</strong>, and I'm skilled in crafting engaging and responsive user interfaces with <strong>CSS</strong>, <strong>Tailwind CSS</strong>, <strong>SCSS</strong> and <strong>HTML</strong>. 
