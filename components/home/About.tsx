  ...
  return (
    ...
    >
      <motion.section>
            ...
            >
              I bring a robust skill set to the table, I have proficiency in <strong>Java</strong>, <strong>JavaScript</strong>, and a suite of frameworks including <strong>React</strong>, <strong>React Native</strong>, <strong>Node.js</strong>, and <strong>Next.js</strong>. My knowledge extends to AWS cloud foundations, navigating services such as <strong>S3</strong> (Simple Storage Service), <strong>RDS</strong> (Relational Database Service), <strong>EC2</strong> (Elastic Compute Cloud) and <strong>VPC</strong> (Virtual Private Cloud).
              In the realm of database management, I am well-versed in both relational databases like <strong>SQL</strong> (Structured Query Language) and also NoSQL databases such as <strong>MongoDB</strong> and <strong>Firebase</strong>. Alongside this, I possess adept knowledge of <strong>Restful APIs</strong>, and I'm skilled in crafting engaging and responsive user interfaces with <strong>CSS</strong>, <strong>Tailwind CSS</strong>, <strong>SCSS</strong> and <strong>HTML</strong>. 
