...
export const about = `As a full-stack developer, I design, build, and maintain software solutions using React, C# .NET, and cloud services like AWS and Azure. My experience includes secure authentication systems, seamless payment integrations, AI-powered applications, and efficient e-commerce platforms. Proficient in MySQL and MS SQL Server, I develop scalable, optimized databases. I leverage DevOps tools for CI/CD, ensuring reliable and maintainable software. Focused on delivering results, I embrace Agile workflows and cross-functional collaboration to build user-centric solutions that drive business success.`
